...
public class Global extends GlobalSettings {
  ...
  public void onStart(Application app) {
    ...
    SurferDB.addSurfer(new SurferFormData("Kelly Slater", "Florida, California, and Hawaii", "11 Time World Surfing Champion", kellyCarouselUrl, kellyBioUrl, kellyBio, "kellySlater", "Male"));
    ...
    SurferDB.addSurfer(new SurferFormData("Malia Manuel", "Hawaii", "", maliaCarouselUrl, maliaBioUrl, maliaBio, "maliaManuel", "Female"));
    
    String jakeCarouselUrl = "http://cdn.surf.transworld.net/files/2011/02/jakemarshall-9323900.jpg";
    ...
    SurferDB.addSurfer(new SurferFormData("Jake Marshall", "California", "", jakeCarouselUrl, jakeBioUrl, jakeBio, "jakeMarshall", "Grom"));
  }
}
